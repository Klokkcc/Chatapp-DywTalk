...
const Login=()=>{
    ...
    return(
        ...
        <div id="tlo">
          ...
          <div id="okienko"> 
            <input id="mail" placeholder='Email' onChange={(e)=>email=e.target.value}></input>
            
            <input type="password" id="haslo" placeholder='Password' onChange={(e)=>password=e.target.value} onKeyDown={sprawdz_czy_enter}></input>
