    ...
    return(
        ...
        <span id="title">DywTalk</span>
            <div id="okienko"> 
                ...
                <input id="email" placeholder='Email' onChange={(e)=>email=e.target.value}></input>
                <input type="password" id="haslo" placeholder='Password' onChange={(e)=>password=e.target.value}></input>
                <input type="password" id="haslo2" placeholder='Repeat password' onChange={(e)=>password2=e.target.value} onKeyDown={sprawdz_czy_enter}></input>
